        ...
        <ul class="nav nav-stacked" id="collection">
            <li class="panel">
                ...
                <ul id="collectionLevel1" class="collapse">
                    ...
                    <li id="wallCoverings"><a href="#">wall coverings</a></li>
                    <li id="wtowCarpets"><a href="#">Wall to wall carpets</a></li>
                    <li id="rugs"><a href="#">rugs</a></li>
                    <li id="woodenFloor"><a href="#">Wooden floorings</a></li>
                    <li id="bedLeninBath"><a href="#">bed lenin & bath</a></li>
                    <li id="accessaries"><a href="#">accessaries</a></li>
                </ul>
            </li>
            <li>
                <a href="#">About</a>
